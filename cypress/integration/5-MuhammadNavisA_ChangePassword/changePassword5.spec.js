describe('Login', function (){
    beforeEach(() => {        
        ...
        // Input Username
        cy.get('#password').type('malangan_12')
        // Input Password                
        cy.get('[class="btn btn-primary btn-block m-t-1"]').should('be.visible').click()   
        // Button Login
    })
    it('Change Password Dengan Angka dan Numerik', () => {  
        ...
        cy.get('#id_password').type('1941720147')
        // Input Current Password
        cy.get('#id_newpassword1').type('1941720147_')
        // Input New Password 1
        cy.get('#id_newpassword2').type('1941720147_')
